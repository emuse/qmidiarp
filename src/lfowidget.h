...
/*!
* @brief Slot for the LfoScreen::mouseEvent signal. This function
* mutes or sets a wave point when the mouse is moved with held buttons.
*
* The mouse events are generated by the LfoScreen.
* It sets a MidiLfo::setCustomWavePoint and calls MidiLfo::newCustomOffset()
* if the left button is held while moving. It calls MidiLfo::setMutePoint()
